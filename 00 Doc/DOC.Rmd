...
This bar chart compares average charges and payments of different medical precedures.  Between the procedures there are covered charges, medicare payments, and total payments out of pocket.  We see a correlation with all procedures that covered charges take most of the cost.  I added a calculated field of average difference between total payments and medicare payments to see how much on average comes directly out of pocket.  We can see Intracranial Hemorrhage procedures are by far the most expensive but for out of pocket payments its almost just as bad as Transient Ischemia.  

Questions Raised by Data:
1. Why are out of pocket expenses for Transient Ischemia just as much as the more expensive overall Intracranial Hemorrhage?
